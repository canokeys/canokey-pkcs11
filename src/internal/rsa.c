 ...
 *
 * This function always hashes the input data (it does not support preâ€hashed inputs).
...
CK_RV pss_encode(CK_BYTE_PTR pbHash, CK_ULONG cbHash, CK_BYTE_PTR pbModulus, CK_ULONG cbModulus, CK_ULONG cbSalt,
  ...
  /* emBits = modBits - 1  â€”â€? RFC 8017 Â§9.1.1 */
