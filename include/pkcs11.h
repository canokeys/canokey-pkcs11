...
#define CK_DECLARE_FUNCTION(returnType, name) CK_SPEC returnType name
#define CK_DECLARE_FUNCTION_POINTER(returnType, name) returnType(*name)
#define CK_CALLBACK_FUNCTION(returnType, name) returnType(*name)
#define CK_DEFINE_FUNCTION(returnType, name) CK_SPEC returnType name
