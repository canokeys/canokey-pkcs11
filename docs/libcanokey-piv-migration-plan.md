...
object/certificate 写入、key generation 和 private material import 已切换到
context mutation，并修复了 lock/status failure cleanup。certificate delete 和
完整 mutation rollback 回归仍待迁移。
