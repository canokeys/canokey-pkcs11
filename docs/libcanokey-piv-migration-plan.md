...
状态：metadata typed scalar fields、certificate、session-scoped PIV object、
metadata-directory 和 container-name reads 已接入；public-key compatibility
conversion、旧 parser 清理和完整回归待完成。
